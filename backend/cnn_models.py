...
class Vgg19Model(CNNModel):
    ...
    def __init__(
        ...
        self.__style_layer_indices = style_layer_indices
    ...
    def style_features(self):
        ...
        feature_extractor = Vgg19FeatureExtractor(img_tensor=self.style_image,pretrained_model=self.model)
    ...
    def content_features(self):
        ...
        feature_extractor = Vgg19FeatureExtractor(img_tensor=self.content_image,pretrained_model=self.model)
